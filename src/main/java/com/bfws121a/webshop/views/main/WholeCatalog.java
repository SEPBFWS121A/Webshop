...
public class WholeCatalog extends FormLayout {
    ...
    public WholeCatalog () {
        ...
        prodList.add(new Product(12350, "icons/Kamera.webp", "Vintage Kamera","Die Vintage Kamera ist ein beeindruckendes Modell im Retro-Stil, dass das Aussehen einer klassischen Kamera der 1950er und 60er Jahre nachbildet. </p>\n" +
